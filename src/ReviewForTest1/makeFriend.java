...
public class makeFriend {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            sb.append(graph[i].id).append(" ").append(graph[i].adjVertexs.size()).append(" ");
            graph[i].adjVertexs.sort((s1,s2) -> Integer.compare(s1.id, s2.id));
            for (Vertex vertex : graph[i].adjVertexs) {
